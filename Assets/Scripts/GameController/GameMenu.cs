...
public class GameMenu : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        else if (text.text == "level2"&&confirmButtonEnabled)
        {
            SceneManager.LoadScene("Scenes/City");
        }
        else if (text.text == "level1"&&confirmButtonEnabled)
        {
